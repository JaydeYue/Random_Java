# Poker Judger
Judge the winner among hands of poker
...
## How to run
Using python 3, put command (python ./run_tests3 "python judge.py") into the command line

run_tests3 is not included since that is not my code.

## Potential problems
Since I am using python 3, "run_tests" doesn't work and only "run_tests3" works. I am also using windows to run and test my code, hopefully there won't be any issues in linux system

## How I solved it/Design decisions
I converted each hand to an integer value with 7 digits, the higher the value the better the hand (for technical details please read function description in my code). Then I just return the ids of people with the best hand value.
